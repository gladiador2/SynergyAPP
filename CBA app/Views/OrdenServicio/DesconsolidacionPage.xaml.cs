...
public partial class DesconsolidacionPage : ContentPage
{
    private readonly int _ordenServicioId;
    ActaViewModel viewModel;
    private readonly OrdenesServiciosRequest request = new();

    public DesconsolidacionPage()
    {
        InitializeComponent();
    }

    public DesconsolidacionPage(int ordenServicioId, ModeloActasOrdenServicio acta) : this()
    {
