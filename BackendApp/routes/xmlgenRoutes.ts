...
router.post('/getDepartamento', (req, res) =>
    handleGetById(req, res, 'departamentoId', DE.getDepartamento)
);

// Distrito
router.post('/getDistrito', (req, res) =>
    handleGetById(req, res, 'distritoId', DE.getDistrito)
);

// Ciudad
router.post('/getCiudad', (req, res) =>
    handleGetById(req, res, 'ciudadId', DE.getCiudad)
);

// Generación de XML DE
